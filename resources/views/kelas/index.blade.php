...
@section('content')
    <section class="custom-banner mb-3">
        ...
        <div class="custom-banner-caption col-10">
            <a href="" class="custom-banner-text uppercase">{{$title}}</a>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <aside class="col-lg-4 main-page-aside">
                    ...
                    <div class="main-page-content-aside mb-1 px-3 px-lg-0">
                        <img src="{{ asset('img/'.$category->image) }}" alt="" class="img-aside">
                        <div class="img-aside-caption">
                            <a href="/c/{{$kelas->slug}}/{{$category->slug}}">
                                <span class="image-aside-title">{{$category->name}}</span>
                                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Unde, accusamus.</p>
                            </a>
                        </div>
                    </div>
                    @endif
